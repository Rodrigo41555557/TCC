...
cod_sugestao int(5) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE elogio (
cod_elogio int(5) NOT NULL AUTO_INCREMENT PRIMARY KEY,
titulo varchar(50) NOT NULL,
...
cod_reclamacao int(5) NOT NULL AUTO_INCREMENT PRIMARY KEY,
titulo varchar(50) NOT NULL,
texto_reclamacao text NOT NULL,
rec_cod_usuario int(5) NOT NULL,
cod_usuario int(5)
);

CREATE TABLE denuncia (
cod_denuncia int(5) NOT NULL AUTO_INCREMENT PRIMARY KEY,
titulo varchar(50) NOT NULL,
...
ALTER TABLE sugestao ADD FOREIGN KEY(cod_usuario) REFERENCES usuario (cod_usuario);
ALTER TABLE elogio ADD FOREIGN KEY(cod_usuario) REFERENCES usuario (cod_usuario);
ALTER TABLE reclamacao ADD FOREIGN KEY(cod_usuario) REFERENCES usuario (cod_usuario);
